...
interface BreadcrumbsProps {
  ...
  navigation?: any;
  rightAlign?: boolean;
  separator?: React.ComponentType | null;
  title?: boolean;
  titleBottom?: boolean;
}
...
const Breadcrumbs: FC<BreadcrumbsProps> = ({ card, divider, icon, icons, maxItems, navigation, rightAlign, separator, title, titleBottom, ...others }) => {
  ...
  const SeparatorIcon = separator ? separator : IconTallymark1;
              ...
              >
                ...
                <Grid item>
                  <MuiBreadcrumbs
                      ...
                      maxItems={maxItems || 8}
                      separator={<SeparatorIcon stroke={1.5} size="1rem" />}
                  >
